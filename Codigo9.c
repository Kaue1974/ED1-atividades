...
void posicionar_jogador( char mapa[LINHAS][COLUNAS][TAM_CELULA], char jogadores[QUANTIDADE_JOGADORES][TAM_JOGADOR] ) { 
    int linha; 
    int coluna; 
    int jogador; 
...
void reposicionar_jogador( char mapa[LINHAS][COLUNAS][TAM_CELULA], char jogadores[QUANTIDADE_JOGADORES][TAM_JOGADOR] ) { 
    int linha_antiga; 
    int coluna_antiga; 
    int linha_nova; 
    int coluna_nova; 
...
int main() { 
    ...
    do { 
        ...
        switch (opcao) { 
            ...
            case 2: 
                posicionar_jogador(mapa, jogadores); 
                break; 
            ...
            case 4: 
                reposicionar_jogador(mapa, jogadores); 
                break; 
